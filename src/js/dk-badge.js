		...
		const template = `
			<div class="dk-badge is-${this.style}">
				...
				<div class="dk-badge_content" data-dk-badge-content id="dk-badge">
					...
					<hr class="dk-badge_hr" role="presentation">
					<p class="dk-badge_data"><a href="https://d-k.io?mtm_campaign=Badge-DK&mtm_source=${document.location}">Powered by DK</a> <span class="is-small">${this.labels.privacy}</span></p>
				</div>
			</div>`;
